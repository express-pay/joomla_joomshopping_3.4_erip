...
define('_JSHOP_HEADING_TITLE_ERROR', 'An error in the payment method ERIP');
define('_JSHOP_HEADING_TITLE', 'The score has been added to the payment method ERIP');
...
define('_JSHOP_TEXT_ABOUT', '«Express Payments: ERIP» - plug-in for integration with the service «Express Payments» (express-pay.by) through the API.
<br/>plugin allows you to invoice in ERIP system to receive and process the payment notice in the ERIP system.
<br/>Description plugin is available at: <a target="blank" href="https://express-pay.by/cms-extensions/joomla#joomshopping_3_4">https://express-pay.by/cms-extensions/joomla#joomshopping_3_4</a>');
define('_JSHOP_MESSAGE_SUCCESS', 'To order a payment, you must go to the section ERIP:
